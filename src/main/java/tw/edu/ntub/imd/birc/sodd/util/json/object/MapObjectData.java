package tw.edu.ntub.imd.birc.sodd.util.json.object;
...
public class MapObjectData implements ResponseData {
    private final tw.edu.ntub.imd.birc.sodd.util.json.object.ObjectData objectData;

    public MapObjectData() {
        objectData = new tw.edu.ntub.imd.birc.sodd.util.json.object.ObjectData();
    }

    protected MapObjectData(tw.edu.ntub.imd.birc.sodd.util.json.object.ObjectData objectData) {
    ...
    public <K, V> MapObjectData addArray(String key, Map<K, V> resource, TripleConsumer<tw.edu.ntub.imd.birc.sodd.util.json.object.ObjectData, K, V> addObjectDataConsumer) {
    ...
    public <K, V> BiConsumer<K, V> addArrayAndAddObjectToNewArray(String key, TripleConsumer<tw.edu.ntub.imd.birc.sodd.util.json.object.ObjectData, K, V> addObjectDataConsumer) {
