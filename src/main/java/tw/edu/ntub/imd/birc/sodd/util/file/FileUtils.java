...
import tw.edu.ntub.imd.birc.sodd.exception.file.InvalidOptionException;
import tw.edu.ntub.imd.birc.sodd.exception.file.UnauthorizedException;
...
public class FileUtils {
    ...
    public Path getFilePath(@NonNull String filePath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.sodd.exception.file.InvalidPathException(e, filePath);
        }
    }
    ...
    public Path getDirectoryPath(@NonNull String firstDirectoryPath, String... subDirectoryPath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.sodd.exception.file.InvalidPathException(e, firstDirectoryPath, subDirectoryPath);
        }
    }
    ...
    public BufferedReader openReader(@NonNull String filePath, @NonNull Charset charset) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.sodd.exception.file.InvalidCharsetException(charset.name(), e);
        } catch (SecurityException e) {
            throw new UnauthorizedException(e);
        } catch (Exception e) {
            throw new UnknownException(e);
