...
import tw.edu.ntub.imd.birc.sodd.databaseconfig.dao.ChartSourceMappingDAO;
...
import tw.edu.ntub.imd.birc.sodd.databaseconfig.entity.ChartSourceMapping;
...
public class ExportServiceImpl extends BaseServiceImpl<ExportBean, Export, Integer> implements ExportService {
    ...
    public void export(Integer chartId, HttpServletResponse response) {
        ...
        ChartSourceMapping chartSourceMapping = chartSourceMappingDAO.findById(chart.getDataSource())
                .orElseThrow(() -> new NotFoundException("查無此原始資料來源"));
        List<Object[]> objects = dataSourceDAO.searchAll(chartSourceMapping.getOriginalSource());
