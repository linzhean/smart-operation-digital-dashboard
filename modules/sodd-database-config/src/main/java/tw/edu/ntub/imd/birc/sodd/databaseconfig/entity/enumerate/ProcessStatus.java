...
public enum ProcessStatus {
    ...
    public static Boolean isAssign(ProcessStatus processStatus) {
        return processStatus.equals(ProcessStatus.ASSIGN);
    }

    public static Boolean isAssigned(ProcessStatus processStatus) {
        return processStatus.equals(ProcessStatus.ASSIGNED);
    }
}
